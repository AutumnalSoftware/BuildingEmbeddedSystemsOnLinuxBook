...
WeatherSystem::WeatherSystem()
    ...
    , m_logQ(64)
    , m_fusedQ(64)
    , m_runLoops(new RunLoops(m_inQ, m_fusedQ, m_logQ))
{
}
...
moodycamel::ReaderWriterQueue<weather::AnyMeasurement, 128>& WeatherSystem::inQueue() noexcept
{
    return m_inQ;
}
...
RunLoops& WeatherSystem::runLoops() noexcept
{
    return *m_runLoops;
}
